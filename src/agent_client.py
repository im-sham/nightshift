...
class OpencodeAgentClient:
    ...
    async def call_agent(
        ...
        """
        Call an opencode agent and return the result.
        
        agent_type: explore, librarian, oracle
...
class MockAgentClient:
    async def call_agent(self, agent_type: str, prompt: str, project_path: Optional[Path] = None) -> dict:
        return {
            "success": True,
            "output": json.dumps([{
                "severity": "info",
