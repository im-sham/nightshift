    ...
    <div class="container">
        ...
        <section class="section">
            ...
            <div class="failure-item">
                <div class="failure-title">{{ task.task_type }} ({{ task.project_name }})</div>
                <div class="failure-meta">model={{ task.model_used or "unknown" }} | completed={{ task.completed_at or "n/a" }}</div>
                <div class="failure-error">{{ task.error or "Unknown failure" }}</div>
            </div>
            {% endfor %}
        </section>
        {% endif %}
...
class ReportGenerator:
    ...
    def generate(
        ...
        failed_tasks: Optional[list[dict]] = None,
    ) -> Path:
